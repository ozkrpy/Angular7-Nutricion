...
import { OptionalTextValidation } from '../../common/validation' 
import { IUser } from '../../usuarios/usuario' 
import { UserService, IUsers } from '../../usuarios/usuario.service'
    ...
    merge(
      ...
      .pipe(
        ...
        switchMap(() => 
        {
          ...
          let info = this.userService.getUsers(
